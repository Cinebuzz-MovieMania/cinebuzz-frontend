...
function MovieDetail({ movie, onClose, persons }) {
  ...
  return (
    <div className="page">
      ...
      <div className="table-container">
        {movies.length === 0 ? (
          <div className="empty">No movies found. Add one to get started.</div>
        ) : (
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              {movies.map((m) => (
                <tr key={m.id} onClick={() => setViewingMovie(m)} style={{ cursor: "pointer" }}>
                  <td>{m.id}</td>
                  <td>{m.title}</td>
                  <td>{m.genre}</td>
                  <td>{m.language}</td>
                  ...
                  <td>
                    <div className="actions">
                      ...
                      <button className="btn btn-sm btn-danger" onClick={(e) => handleDelete(m.id, e)}>Delete</button>
                    </div>
                  </td>
                </tr>
              ))}
